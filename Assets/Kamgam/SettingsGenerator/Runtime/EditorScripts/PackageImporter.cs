...
namespace Kamgam.SettingsGenerator
{
    public static class PackageImporter
    {
        ...
        {
			new Package( PackageType.URP,  "Assets/Kamgam/SettingsGenerator/Packages/SettingsGeneratorURP.unitypackage" ),
            new Package( PackageType.HDRP, "Assets/Kamgam/SettingsGenerator/Packages/SettingsGeneratorHDRP.unitypackage" ),
            new Package( PackageType.UIToolkitPackage, "Assets/Kamgam/SettingsGenerator/Packages/SettingsGeneratorUIToolkitPackage.unitypackage" ),
            new Package( PackageType.UIToolkitModule, "Assets/Kamgam/SettingsGenerator/Packages/SettingsGeneratorUIToolkitModule.unitypackage" )
        };
        ...
        static List<PackageType> initializePackagesToImport()
        {
            ...
            Debug.Log("PackageImporter: Scheduling upgrade to UI Toolkit module.");
            packages.Add(PackageType.UIToolkitModule);
#elif KAMGAM_UI_ELEMENTS
            Debug.Log("PackageImporter: Scheduling upgrade to 'com.unity.ui' UIToolkit package. BEWARE: this package is outdated.");
            packages.Add(PackageType.UIToolkitPackage);
#else
            Debug.Log("PackageImporter: No UIToolkit detected, no import needed.");
#endif
