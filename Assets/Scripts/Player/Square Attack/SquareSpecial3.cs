...
public class SquareSpecial3 : MonoBehaviour
{
   ...
   private async void Fade()
   {
      ...
      tasks.Add(top.DOFade(0f, 0.3f).SetEase(Ease.Linear).AsyncWaitForCompletion());
      tasks.Add(left.DOFade(0f, 0.3f).SetEase(Ease.Linear).AsyncWaitForCompletion());
      tasks.Add(right.DOFade(0f, 0.3f).SetEase(Ease.Linear).AsyncWaitForCompletion());
      tasks.Add(bottom.DOFade(0f, 0.3f).SetEase(Ease.Linear).AsyncWaitForCompletion());
